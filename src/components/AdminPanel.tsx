...
type Config = {
  ...
  password: string
  aiStrictness: 'Relaxed' | 'Normal' | 'Strict'
  autoKick: number
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="glass-panel p-6 uniform-panel" style={{ gridColumn: '1 / -1' }}>
        ...
        <div className="form-group-inline" style={{ marginBottom: 12 }}>
          ...
          <button className="btn btn-primary" onClick={addPlayer} disabled={sessionLocked}>
            Add
          </button>
      ...
      <div className="panel-grid">
        <div className="glass-panel p-6 uniform-panel">
          ...
          <div className="form-group-inline">
            <button className="btn btn-primary" onClick={() => setState('running')}>
              start
            </button>
            <button className="btn btn-secondary" onClick={() => setState('paused')}>
              pause
            </button>
            <button className="btn btn-secondary" onClick={() => reset(duration)}>
              reset
            </button>
            <button className="btn btn-danger" onClick={() => setState('expired')}>
              stop
            </button>
          </div>
        </div>
