...
from core.inference import load_model_and_mapping, predict_image_region_based
from core.patch_extraction import AggregationStrategy
...
def demo_aggregation_strategies(model, idx_to_class, image, image_name):
    ...
    for strategy_name, strategy in strategies.items():
        ...
        from core.patch_extraction import SlidingWindowDetector
