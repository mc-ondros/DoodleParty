...
from core.patch_extraction import (
    SlidingWindowDetector,
    AggregationStrategy
)
from core.contour_detection import (
    ContourDetector,
    ContourRetrievalMode
)
from core.tile_detection import (
    TileDetector,
    TileSize
)
from core.content_removal import (
    ContentRemover,
    RemovalStrategy
)
from core.shape_detection import (
    ShapeDetector
)
...
def api_content_highlight() -> Tuple[Union[Dict[str, Any], Any], int]:
    ...
    try:
        ...
        if detection_method == 'tile':
            ...
            from core.tile_detection import TileDetectionResult, TileInfo, TileCoordinate
            ...
            from core.contour_detection import ContourDetectionResult, ContourInfo
